"""
ReportGenerator — matching report generation.

Takes a JobDescription, Resume, and MatchResult and produces a structured
MatchReport with scores, ratings, skill gap analysis, recommendations, and a
full markdown report. The structured fields are always computed
deterministically; the narrative report is rendered from a template by default,
or generated by an LLM grounded on those fields when a client is supplied
